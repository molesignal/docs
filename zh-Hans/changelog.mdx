---
title: "更新日志"
description: "产品更新与发布记录，实时同步 GitHub Releases。"
---
...
(function () {
  ...
  function render(releases) {
    if (!releases.length) {
      return '<p>暂无发布记录。<a href="https://github.com/' + REPO + '/releases" target="_blank" rel="noopener">在 GitHub 上查看</a>。</p>';
    }
    return releases.map(function (r) {
      ...
      var prerelease = r.prerelease
        ...
        : "";
      var body = md2html(r.body) || "<p><em>无发布说明。</em></p>";
  ...
  /* --- main --- */
  root.innerHTML =
    '<p style="color:var(--mint-text-secondary, #64748b);padding:1rem 0">正在加载发布记录…</p>';
  ...
  fetch("https://api.github.com/repos/" + REPO + "/releases?per_page=" + PER_PAGE)
    ...
    .catch(function (err) {
      root.innerHTML =
        ...
        "<p><strong>无法加载发布记录。</strong></p>" +
        '<p style="font-size:0.875rem;color:var(--mint-text-secondary,#64748b)">' +
        '<a href="https://github.com/' + REPO + '/releases" target="_blank" rel="noopener">在 GitHub 上查看 →</a>' +
        "</p></div>";
