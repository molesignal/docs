...
<Frame caption="写入路径">
  <img src="/images/diagrams/ingest.zh-Hans.light.png" alt="写入路径" className="block dark:hidden" />
  <img src="/images/diagrams/ingest.zh-Hans.dark.png" alt="写入路径" className="hidden dark:block" />
</Frame>
...
<Frame caption="查询路径">
  <img src="/images/diagrams/query.zh-Hans.light.png" alt="查询路径" className="block dark:hidden" />
  <img src="/images/diagrams/query.zh-Hans.dark.png" alt="查询路径" className="hidden dark:block" />
</Frame>
...
<Frame caption="异步搜索作业管线">
  <img src="/images/diagrams/async.zh-Hans.light.png" alt="异步搜索作业管线" className="block dark:hidden" />
  <img src="/images/diagrams/async.zh-Hans.dark.png" alt="异步搜索作业管线" className="hidden dark:block" />
</Frame>
...
<Frame caption="联邦 / 多集群查询">
  <img src="/images/diagrams/federated.zh-Hans.light.png" alt="联邦 / 多集群查询" className="block dark:hidden" />
  <img src="/images/diagrams/federated.zh-Hans.dark.png" alt="联邦 / 多集群查询" className="hidden dark:block" />
</Frame>
