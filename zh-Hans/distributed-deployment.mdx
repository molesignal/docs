...
MoleSignal 是一个**单一二进制（single binary）**：同一份可执行文件（同一个镜像）服务所有角色，可自行选择某个进程运行哪些角色。这让它既能当作一条命令启动的沙箱，也能横向扩展成多角色集群。
...
<Frame caption="写入路径">
  <img src="/images/architecture/ingest_zh-Hans_light.svg" alt="写入路径" className="block dark:hidden" />
  <img src="/images/architecture/ingest_zh-Hans_dark.svg" alt="写入路径" className="hidden dark:block" />
</Frame>
...
<Frame caption="查询路径">
  <img src="/images/architecture/query_zh-Hans_light.svg" alt="查询路径" className="block dark:hidden" />
  <img src="/images/architecture/query_zh-Hans_dark.svg" alt="查询路径" className="hidden dark:block" />
</Frame>
...
<Frame caption="异步搜索作业管线">
  <img src="/images/architecture/async_zh-Hans_light.svg" alt="异步搜索作业管线" className="block dark:hidden" />
  <img src="/images/architecture/async_zh-Hans_dark.svg" alt="异步搜索作业管线" className="hidden dark:block" />
</Frame>
...
<Frame caption="联邦 / 多集群查询">
  <img src="/images/architecture/federated_zh-Hans_light.svg" alt="联邦 / 多集群查询" className="block dark:hidden" />
  <img src="/images/architecture/federated_zh-Hans_dark.svg" alt="联邦 / 多集群查询" className="hidden dark:block" />
</Frame>
