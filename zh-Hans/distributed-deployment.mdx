...
<Frame caption="写入路径">
  <img src="/diagrams/ingest_zh-Hans_light.png" alt="写入路径" className="block dark:hidden" />
  <img src="/diagrams/ingest_zh-Hans_dark.png" alt="写入路径" className="hidden dark:block" />
</Frame>
...
<Frame caption="查询路径">
  <img src="/diagrams/query_zh-Hans_light.png" alt="查询路径" className="block dark:hidden" />
  <img src="/diagrams/query_zh-Hans_dark.png" alt="查询路径" className="hidden dark:block" />
</Frame>
...
<Frame caption="异步搜索作业管线">
  <img src="/diagrams/async_zh-Hans_light.png" alt="异步搜索作业管线" className="block dark:hidden" />
  <img src="/diagrams/async_zh-Hans_dark.png" alt="异步搜索作业管线" className="hidden dark:block" />
</Frame>
...
<Frame caption="联邦 / 多集群查询">
  <img src="/diagrams/federated_zh-Hans_light.png" alt="联邦 / 多集群查询" className="block dark:hidden" />
  <img src="/diagrams/federated_zh-Hans_dark.png" alt="联邦 / 多集群查询" className="hidden dark:block" />
</Frame>
