...
<Frame caption="调度流水线">
  <img src="/images/diagrams/pipeline_zh-Hans_light.png" alt="调度流水线" className="block dark:hidden" />
  <img src="/images/diagrams/pipeline_zh-Hans_dark.png" alt="调度流水线" className="hidden dark:block" />
</Frame>
