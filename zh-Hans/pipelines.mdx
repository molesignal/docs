...
<Frame caption="调度流水线">
  <img src="/images/diagrams/pipeline.zh-Hans.light.png" alt="调度流水线" className="block dark:hidden" />
  <img src="/images/diagrams/pipeline.zh-Hans.dark.png" alt="调度流水线" className="hidden dark:block" />
</Frame>
