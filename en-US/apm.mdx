...
- OpenTelemetry traces sent to a MoleSignal [trace ingest endpoint](/en-US/ingestion);
...
<CardGroup cols={2}>
  ...
  <Card title="Trace ingestion" icon="arrow-right-to-bracket" href="/en-US/ingestion">
