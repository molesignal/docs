...
<Frame caption="Ingest path">
  <img src="/images/diagrams/ingest.en.light.svg" alt="Ingest path" className="block dark:hidden" />
  <img src="/images/diagrams/ingest.en.dark.svg" alt="Ingest path" className="hidden dark:block" />
</Frame>
...
<Frame caption="Query path">
  <img src="/images/diagrams/query.en.light.svg" alt="Query path" className="block dark:hidden" />
  <img src="/images/diagrams/query.en.dark.svg" alt="Query path" className="hidden dark:block" />
</Frame>
...
<Frame caption="Async search job pipeline">
  <img src="/images/diagrams/async.en.light.svg" alt="Async search job pipeline" className="block dark:hidden" />
  <img src="/images/diagrams/async.en.dark.svg" alt="Async search job pipeline" className="hidden dark:block" />
</Frame>
...
<Frame caption="Federated / multi-cluster query">
  <img src="/images/diagrams/federated.en.light.svg" alt="Federated / multi-cluster query" className="block dark:hidden" />
  <img src="/images/diagrams/federated.en.dark.svg" alt="Federated / multi-cluster query" className="hidden dark:block" />
</Frame>
