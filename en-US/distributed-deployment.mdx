...
<Frame caption="Ingest path">
  <img src="/diagrams/ingest_en_light.png" alt="Ingest path" className="block dark:hidden" />
  <img src="/diagrams/ingest_en_dark.png" alt="Ingest path" className="hidden dark:block" />
</Frame>
...
<Frame caption="Query path">
  <img src="/diagrams/query_en_light.png" alt="Query path" className="block dark:hidden" />
  <img src="/diagrams/query_en_dark.png" alt="Query path" className="hidden dark:block" />
</Frame>
...
<Frame caption="Async search job pipeline">
  <img src="/diagrams/async_en_light.png" alt="Async search job pipeline" className="block dark:hidden" />
  <img src="/diagrams/async_en_dark.png" alt="Async search job pipeline" className="hidden dark:block" />
</Frame>
...
<Frame caption="Federated / multi-cluster query">
  <img src="/diagrams/federated_en_light.png" alt="Federated / multi-cluster query" className="block dark:hidden" />
  <img src="/diagrams/federated_en_dark.png" alt="Federated / multi-cluster query" className="hidden dark:block" />
</Frame>
