...
<Frame caption="Ingest path">
  <img src="/images/diagrams/ingest.en.light.png" alt="Ingest path" className="block dark:hidden" />
  <img src="/images/diagrams/ingest.en.dark.png" alt="Ingest path" className="hidden dark:block" />
</Frame>
...
<Frame caption="Query path">
  <img src="/images/diagrams/query.en.light.png" alt="Query path" className="block dark:hidden" />
  <img src="/images/diagrams/query.en.dark.png" alt="Query path" className="hidden dark:block" />
</Frame>
...
<Frame caption="Async search job pipeline">
  <img src="/images/diagrams/async.en.light.png" alt="Async search job pipeline" className="block dark:hidden" />
  <img src="/images/diagrams/async.en.dark.png" alt="Async search job pipeline" className="hidden dark:block" />
</Frame>
...
<Frame caption="Federated / multi-cluster query">
  <img src="/images/diagrams/federated.en.light.png" alt="Federated / multi-cluster query" className="block dark:hidden" />
  <img src="/images/diagrams/federated.en.dark.png" alt="Federated / multi-cluster query" className="hidden dark:block" />
</Frame>
