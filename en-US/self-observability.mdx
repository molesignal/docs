...
MoleSignal can ingest platform telemetry into the protected `_sys` organization. Each signal uses
the exact stream name `_molesignal` with a corresponding stream type.
