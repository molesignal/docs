...
MoleSignal can create a stream on first ingest or you can predeclare one. As data arrives, schema
evolution adds compatible fields.

From stream detail you can review:
...
query selectors. A routing pipeline can still read it. Manage `extend` data through **Extend
tables** rather than the generic telemetry query path.

## Retention and deletion

Retention controls when the compactor removes data. Changing retention affects future cleanup; it
