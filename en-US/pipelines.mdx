...
<Frame caption="Scheduled pipeline">
  <img src="/diagrams/pipeline_en_light.png" alt="Scheduled pipeline" className="block dark:hidden" />
  <img src="/diagrams/pipeline_en_dark.png" alt="Scheduled pipeline" className="hidden dark:block" />
</Frame>

{/* UPLOAD-TEST: markdown ref to force Mintlify to upload this asset */}
![pipeline upload test](/diagrams/pipeline_en_light.png)
