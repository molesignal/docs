...
<Note>
  Scheduled pipelines transform data **after ingestion**, as a recurring job. To transform events on
...
A non-queryable stream still ingests and retains data and feeds the pipeline, but the stream is
