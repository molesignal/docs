...
<Frame caption="Scheduled pipeline">
  <img src="/images/diagrams/pipeline.en.light.svg" alt="Scheduled pipeline" className="block dark:hidden" />
  <img src="/images/diagrams/pipeline.en.dark.svg" alt="Scheduled pipeline" className="hidden dark:block" />
</Frame>
