...
A **stream** is the typed contract shared by ingest and query. It has a name, a `stream_type`, an
...
organization your **workspace**. Telemetry and product resources belong to exactly one
...
history, platform administrators, and global organization operations. It is not a normal tenant.
...
authorize the requested action before returning or changing it.
