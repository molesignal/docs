...
|---|---|---|
| `intelligence` | `/api/v1/intelligence/*` | `intelligence.use`, `intelligence.manage`, or `intelligence.approve` |
...
observability, including standard profile ingest and single-window flame graphs.
...
This requires `sys.licenses.read`. See [Editions and licensing](/en-US/licensing) for upload and
activation.
