---
title: "API catalog"
description: "A current map of MoleSignal HTTP API families and the permissions or scopes that protect them."
---
...
| Preferences & settings | `/me/*`, `/workspace/preferences`, `/settings/*`, `/billing/*` | Personal preferences, workspace defaults, runtime policy, and supported billing configuration. |
...
| Alerting | `/alerts/rules`, `/alerts/incidents`, `/alerts/channels`, `/schedules`, `/alerts/mutes` | Detection, response, on-call, and notifications. |
...
| RUM | `/rum/v1/*`, `/rum/sessions/*`, `/sourcemaps` | Browser telemetry, replay, errors, related traces, and source maps. |
