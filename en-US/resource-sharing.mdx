...
MoleSignal shares a specific dashboard or report. It never turns a share link into a normal user
token.
...
sessions, or rotate it when the URL may have leaked.

You need the resource's share permission, such as `dashboards.share`, and the source resource is
re-authorized before a share is created.
