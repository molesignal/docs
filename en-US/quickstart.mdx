---
title: "Quickstart"
description: "Start MoleSignal, ingest a log event, and query the event in a few minutes."
---

This guide starts MoleSignal locally, ingests a log event, and queries the event through the authenticated
HTTP API.
...
<CardGroup cols={2}>
  <Card title="Ingest from an existing stack" icon="inbox" href="/en-US/ingestion">
