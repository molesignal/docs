---
title: "Quickstart"
description: "Start MoleSignal, ingest a log event, and query it in a few minutes."
---

This guide starts MoleSignal locally, ingests a log event, and queries it through the authenticated
HTTP API.
