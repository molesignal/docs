...
|---|---|---|
| `applicationId`, `clientToken`, `site` | Required | Application identity, authentication, and ingestion endpoint |
| `service` | `applicationId` | Service stored on actions and errors |
| `env`, `version`, `user`, `globalContext` | Unset | Deployment, release, identity, and custom dimensions |
